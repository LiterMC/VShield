...
import com.github.litermc.vshield.platform.ForgeConfigFile;
...
public class ModEntry {
	...
	private void onCommonSetup(final FMLCommonSetupEvent event) {
		event.enqueueWork(VShieldListeners::onModSetup);
	}
	...
	public static void onServerTick(final TickEvent.ServerTickEvent event) {
		switch (event.phase) {
		case START -> VShieldListeners.preServerTick(event.getServer());
		case END -> VShieldListeners.postServerTick(event.getServer());
		}
	}

	@SubscribeEvent
	public static void onRegisterCommands(final RegisterCommandsEvent event) {
		VShieldCommands.register(event.getDispatcher());
	}
